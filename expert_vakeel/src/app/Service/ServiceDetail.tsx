...
import { ArrowLeft, Loader, Check, AlertCircle, Phone, FileText, Calendar, Shield, Clock } from "lucide-react";
    ...
    const handleSubmitBooking = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Use service.number if available, otherwise fallback to a default or handle error
                // Assuming service.number is the phone number as requested
                const targetNumber = service.number ? service.number.replace(/\D/g, '') : "919711840150";
        ...
        return (
            <main className="min-h-[100dvh] bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-gray-500">Loading service details...</p>
                </div>
            </main>
        );
    }
        ...
        return (
            <main className="min-h-[100dvh] bg-white flex items-center justify-center">
                <div className="text-center max-w-md px-4">
                    ...
                    <h2 className="mb-2 text-xl font-bold text-gray-900">Service Not Found</h2>
                    <p className="mb-6 text-gray-600">{error || "The service you are looking for does not exist."}</p>
                    <button
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-gray-100">
                            <h2 className="mb-4 text-xl font-bold text-gray-900">About this Service</h2>
                            ...
                            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div className="flex items-center gap-3 rounded-2xl bg-blue-50 p-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-semibold text-gray-900">Expert Legal</p>
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-8 rounded-3xl bg-white p-6 shadow-xl ring-1 ring-gray-100 border-t-4 border-blue-600">
                            <div className="mb-6 rounded-2xl bg-gradient-to-br from-gray-50 to-blue-50 p-4 text-center">
                                ...
                                <p className="text-lg font-bold text-gray-900">Book a Consultation</p>
                            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 transition-all">
                    <div className="w-full max-w-2xl transform overflow-hidden rounded-3xl bg-white shadow-2xl transition-all max-h-[90vh] flex flex-col">
                        ...
                        <div className="border-b border-gray-100 bg-gray-50/50 p-6">
                            ...
                            <p className="text-sm text-gray-500">Complete the details below to schedule your service.</p>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 md:p-8">
                            ...
                            {bookingStatus && (
                                <div
                                    className={`mb-6 flex items-center gap-3 rounded-2xl border p-4 text-sm ${bookingStatus === "success"
                                ...
                                <div>
                                    ...
                                    <div className="grid gap-2 sm:grid-cols-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                                        {service.categories.map((category, index) => (
                                            <label
                                                key={index}
                                                className={`flex cursor-pointer items-center gap-3 rounded-xl border p-3 transition-all ${selectedCategories.includes(category)
                                                    ? "border-blue-500 bg-blue-50 ring-1 ring-blue-500"
                                                    : "border-gray-200 hover:bg-gray-50"
                                                    }`}
                                            >
                                                <div className={`flex h-5 w-5 items-center justify-center rounded border ${selectedCategories.includes(category) ? "border-blue-500 bg-blue-500" : "border-gray-300 bg-white"
                                                    }`}>
                                                ...
                                                <input
                                                    ...
                                                    className="hidden"
                                                />
                                                <span className={`text-sm font-medium ${selectedCategories.includes(category) ? "text-blue-700" : "text-gray-700"}`}>
                                                    {category}
                                                </span>
                                            </label>
                                        ))}
